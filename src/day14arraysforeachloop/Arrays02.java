...
public class Arrays02 {
    ...
    public static void main(String[] args) {
        ...
        int arr[] = {5, 1, 5, -3};  //Array e sayilari yerlestriyorux
        int eleman = 7;            // Hangi elamani aradigimizi int e koyuyoruz
        int counter = 0;// "flag": Bazi durumlarin olup olmadigini kontrol etmek icin "flag" kullanilir.
            //Counter koduyla arama yapiyoruz
        ...
        sentence = sentence.replaceAll("\\p{Punct}", ""); //Noktalama isaretlerini kaldirdim
        System.out.println(sentence);

        String words[] = sentence.split(" ");  //

        Arrays.sort(words, Comparator.comparingInt(String::length)); //Karsilastirmayi uzunluga gore yap

        System.out.println(Arrays.toString(words));//[ne, ki, Java, kolay, kolaydir, calisana, calismayana]
        System.out.println(words[words.length-1]);//calismayana  //Bu kod en uzunu verir
    }
}