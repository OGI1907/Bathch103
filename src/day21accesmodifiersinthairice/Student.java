package day21accesmodifiersinthairice;
...
public class Student {
    ...
    public String stdName = "OguzhanYildiz";

    // protected olanlar baska package'lerde kullanilmaz ancak baska package de child class icinden kullanilabilir
    protected String adress = "Malmo";

    //default olanlar baska Package de calismaz
    String email = "Oguzhanyiildiiz1907@gmail.com";

    //private olanlar sadece olustrudklari Class icinde kullanilabilirler
    private String stdId = "19071998";
}
