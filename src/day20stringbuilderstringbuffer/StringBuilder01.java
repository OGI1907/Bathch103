...
public class StringBuilder01 {
     ...
     */
        ...
        //StirngBuilder'larda character sayisi nasil bulunur?
        ...
        //delete(3,18) ==> Index 3(dahil)den index 18(haric) e kadar tum charecterleri siler
        strb3.delete(3,18);
        System.out.println(strb3);

        //deleteCharAtt(2) index 2 yi siler

        strb3.deleteCharAt(2);
        System.out.println(strb3); //Cammmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm

        //reverse() method u StringBuilder i tewrs cevirir. Ali==>ilA

        strb3.reverse();
        System.out.println(strb3);


       //"Immutable" larda orjinal degeri degsitmek icin mehod u kullanmak yeterli olmaz bir de atama islemi yapmalisiiz
        String abc = "Java";
        abc.replace("a","i");
      ...
      //                          ii) a alfabetik srada 'den sonra gelirse pozitif olarak siralama farki gosterir
      //                          iii) a alfabetik sirada "b" den once gelirse negatif olarak aradaki alfabetik siralma farki gosterir
